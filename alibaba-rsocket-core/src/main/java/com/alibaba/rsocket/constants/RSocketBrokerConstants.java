...
/**
 * Constant collection used in the {@code alibaba-rsocket-broker} project.
 */
public interface RSocketBrokerConstants {

    /**
     * The broker default startup ip:port url.
     */
    String BROKER_STARTUP_URL = "tcp://127.0.0.1:9999";

    /**
     * The {@code Reactive Stream} constants.
     */
    interface ReactiveStreamConstants {
